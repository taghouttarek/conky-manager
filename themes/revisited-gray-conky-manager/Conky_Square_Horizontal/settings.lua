...
operator_transpose = {CAIRO_OPERATOR_OVER,
...
function draw_function(cr)
    ...
    -- Start with 172
    	...
    	local gap_x = 10
	local gap_y = 10
	local gap_x_fix = positions["revisited-gray-conky-manager"].x + 2
   	local gap_y_fix = positions["revisited-gray-conky-manager"].y + 2
