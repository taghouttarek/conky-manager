...
local script = os.getenv("HOME") .. "/.config/conky/crypto-gray-conky-manager/crypto_price.py"
...
function draw_function(cr)
    ...
    local widget_x = positions["crypto-gray-conky-manager"].x
    local widget_y = positions["crypto-gray-conky-manager"].y
